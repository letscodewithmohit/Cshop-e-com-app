    ...
    <Layout>
      ...
      <div>
        ...
        <div className="relative ">
          ...
          <h2 className="absolute top-[40%] md:left-[30%] left-[20%] sm:left-[10%] text-white font-semibold  text-3xl md:text-5xl border-b-4 border-red-600"></h2>
        </div>
        {/* Login box */}

        <div className="container px-5 py-10 mx-auto flex ">
          {/* form box */}
          <div className="mx-auto bg-[#f7f6f6] rounded-lg p-8 flex flex-col mt-4 md:mt-0 shadow-md  w-[500px]">
            <h2 className=" text-3xl mb-5 font-medium title-font">LOGIN</h2>
